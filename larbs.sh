...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/callamaris/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/callamaris/LARBS/master/progs.csv"
